/* Section: Chapter03Mirror — byte-for-byte port of /tmp/bundle/template.html.  
                  ...
                  <div data-reactive="" data-glow="rgba(233,192,106,.6)" style={{ display: 'block', width: 'min(380px,92vw)', position: 'relative', borderRadius: '22px', overflow: 'hidden', background: 'radial-gradient(125% 80% at 50% 0%,#7F77DD2e,#1c0d16 58%,#140810)', border: '1px solid rgba(233,192,106,.85)', boxShadow: '0 40px 90px -34px rgba(0,0,0,.85),0 0 0 1px rgba(233,192,106,.33),0 0 38px -6px rgba(233,192,106,.4)', padding: '20px' }}>
                    ...
                    <div style={{ position: 'relative', zIndex: '3' }}>
                      ...
                      <div style={{ position: 'relative', height: '448px' }}>
                        {' '}
                        <div data-mc="" style={{ position: 'absolute', inset: '0', opacity: '0', transition: 'opacity .55s', display: 'flex', flexDirection: 'column' }}>
                          {' '}
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2px' }}>
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '7px' }}>
                              <span style={{ width: '24px', height: '24px', borderRadius: '7px', display: 'grid', placeItems: 'center', background: 'rgba(127,119,221,.14)', border: '.5px solid rgba(127,119,221,.33)', color: '#7F77DD', fontSize: '13px' }}>
                                ▲
                              </span>
                              <span style={{ fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '9.5px', letterSpacing: '.18em', textTransform: 'uppercase', color: '#7F77DD' }}>
                                Career
                              </span>
                            </span>
                            {' '}
                          ...
                          <div style={{ position: 'relative', width: '116px', height: '126px', margin: '0 auto' }}>
                            ...
                            <svg viewBox="0 0 120 120" style={{ position: 'absolute', left: '3px', top: '0', width: '110px', height: '110px', transform: 'rotate(-90deg)' }}>
                              ...
                              <circle data-mring="" data-off="0" cx="60" cy="60" r="46" fill="none" stroke="#7F77DD" strokeWidth="8" strokeLinecap="round" strokeDasharray="289" strokeDashoffset="289" style={{ filter: 'drop-shadow(0 0 6px rgba(127,119,221,.65))' }} />
                            </svg>
                            {' '}
                            <div style={{ position: 'absolute', left: '3px', top: '0', width: '110px', height: '110px', display: 'grid', placeItems: 'center' }}>
                              <span style={{ fontSize: '34px', filter: 'drop-shadow(0 0 12px rgba(127,119,221,.8))', animation: 'bob 3.6s ease-in-out infinite' }}>
                                🎭
                              </span>
                            </div>
                            {' '}
                            <div style={{ position: 'absolute', bottom: '0', left: '0', right: '0', textAlign: 'center', fontFamily: '\'Sora\',sans-serif', fontWeight: '800', fontSize: '10px', letterSpacing: '.14em', color: '#7F77DD' }}>
                              DEPTH 5/5
                            </div>
                            {' '}
                          </div>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '10px', margin: '8px 0 6px', paddingTop: '11px', borderTop: '.5px solid rgba(255,255,255,.08)' }}>
                            ...
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '10px', letterSpacing: '.06em', textTransform: 'uppercase', color: '#c4a0b2', background: 'rgba(196,160,178,.12)', border: '.5px solid rgba(196,160,178,.27)', borderRadius: '999px', padding: '3px 9px' }}>
                              → steady
                            </span>
                            {' '}
                          </div>
                          ...
                          <svg viewBox="0 0 248 66" preserveAspectRatio="none" style={{ width: '100%', height: '42px', display: 'block', overflow: 'visible' }}>
                            <path data-mspark="" d="M0 23.7 L41.3 16.9 L82.7 23.7 L124 10 L165.3 16.9 L206.7 10 L248 16.9" fill="none" stroke="#7F77DD" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="600" strokeDashoffset="600" style={{ filter: 'drop-shadow(0 0 4px rgba(127,119,221,.53))' }} />
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'baseline', gap: '4px', fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '11px', color: '#7F77DD' }}>
                              <span>
                                📸
                              </span>
                              18
                            ...
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'baseline', gap: '4px', fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '11px', color: '#c87c4a' }}>
                              <span>
                                💬
                              </span>
                              14
                            ...
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'baseline', gap: '4px', fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '11px', color: '#c1216b' }}>
                              <span>
                                ♥
                              </span>
                              19
                            ...
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'baseline', gap: '4px', fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '11px', color: '#5B8A5E' }}>
                              <span>
                                ✦
                              </span>
                              7
                            ...
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'baseline', gap: '4px', fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '11px', color: '#9a7bd0' }}>
                              <span>
                                👁
                              </span>
                              60
                        ...
                        <div data-mc="" style={{ position: 'absolute', inset: '0', opacity: '0', transition: 'opacity .55s', display: 'flex', flexDirection: 'column' }}>
                          ...
                          <div style={{ position: 'relative', width: '116px', height: '126px', margin: '0 auto' }}>
                            ...
                            {' '}
                            <div style={{ position: 'absolute', left: '3px', top: '0', width: '110px', height: '110px', display: 'grid', placeItems: 'center' }}>
                              <span style={{ fontSize: '34px', filter: 'drop-shadow(0 0 12px rgba(231,84,138,.8))', animation: 'bob 3.6s ease-in-out infinite' }}>
                                📱
                              </span>
                            </div>
                            {' '}
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '10px', margin: '8px 0 6px', paddingTop: '11px', borderTop: '.5px solid rgba(255,255,255,.08)' }}>
                            ...
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '10px', letterSpacing: '.06em', textTransform: 'uppercase', color: '#7fd49a', background: 'rgba(127,212,154,.12)', border: '.5px solid rgba(127,212,154,.27)', borderRadius: '999px', padding: '3px 9px' }}>
                              ↗ rising
                            </span>
                            {' '}
                          </div>
                        ...
                        <div data-mc="" style={{ position: 'absolute', inset: '0', opacity: '0', transition: 'opacity .55s', display: 'flex', flexDirection: 'column' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2px' }}>
                            {' '}
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '7px' }}>
                              <span style={{ width: '24px', height: '24px', borderRadius: '7px', display: 'grid', placeItems: 'center', background: 'rgba(193,33,107,.14)', border: '.5px solid rgba(193,33,107,.33)', color: '#c1216b', fontSize: '13px' }}>
                                ♥
                              </span>
                              <span style={{ fontFamily: '\'Sora\',sans-serif', fontWeight: '700', fontSize: '9.5px', letterSpacing: '.18em', textTransform: 'uppercase', color: '#c1216b' }}>
                                Relationship
                              </span>
                            </span>
                            {' '}
                          ...
                          <div style={{ position: 'relative', width: '116px', height: '126px', margin: '0 auto' }}>
                            ...
                            <svg viewBox="0 0 120 120" style={{ position: 'absolute', left: '3px', top: '0', width: '110px', height: '110px', transform: 'rotate(-90deg)' }}>
                              <circle cx="60" cy="60" r="46" fill="none" stroke="rgba(255,255,255,.08)" strokeWidth="8" />
                              <circle data-mring="" data-off="115.6" cx="60" cy="60" r="46" fill="none" stroke="#c1216b" strokeWidth="8" strokeLinecap="round" strokeDasharray="289" strokeDashoffset="289" style={{ filter: 'drop-shadow(0 0 6px rgba(193,33,107,.65))' }} />
                            </svg>
                            {' '}
                            <div style={{ position: 'absolute', left: '3px', top: '0', width: '110px', height: '110px', display: 'grid', placeItems: 'center' }}>
                              <span style={{ fontSize: '34px', filter: 'drop-shadow(0 0 12px rgba(193,33,107,.8))', animation: 'bob 3.6s ease-in-out infinite' }}>
                                💌
                              </span>
                            </div>
                            {' '}
                            <div style={{ position: 'absolute', bottom: '0', left: '0', right: '0', textAlign: 'center', fontFamily: '\'Sora\',sans-serif', fontWeight: '800', fontSize: '10px', letterSpacing: '.14em', color: '#c1216b' }}>
                              DEPTH 3/5
                            </div>
                            {' '}
                          </div>
                          ...
                          {' '}
                          <svg viewBox="0 0 248 66" preserveAspectRatio="none" style={{ width: '100%', height: '42px', display: 'block', overflow: 'visible' }}>
                            <path data-mspark="" d="M0 48.4 L41.3 43.6 L82.7 48.4 L124 34 L165.3 29.2 L206.7 19.6 L248 10" fill="none" stroke="#c1216b" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="600" strokeDashoffset="600" style={{ filter: 'drop-shadow(0 0 4px rgba(193,33,107,.53))' }} />
                      ...
                      <div style={{ marginTop: '14px', paddingTop: '13px', borderTop: '.5px solid rgba(255,255,255,.08)' }}>
                        ...
                        <div style={{ display: 'flex', gap: '7px' }}>
                          ...
                          <span style={{ flex: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,.03)', border: '.5px solid rgba(255,255,255,.07)', borderRadius: '12px', padding: '10px 4px 8px' }}>
                            {' '}
                            <span style={{ display: 'flex', alignItems: 'flex-end', gap: '3px', height: '32px' }}>
                              <span style={{ width: '5px', height: '31px', borderRadius: '2px 2px 0 0', background: '#7F77DD', display: 'block' }}>
                              </span>
                              <span style={{ width: '5px', height: '26px', borderRadius: '2px 2px 0 0', background: '#7F77DD', opacity: '.7', display: 'block' }}>
                              </span>
                              <span style={{ width: '5px', height: '16px', borderRadius: '2px 2px 0 0', background: '#7F77DD', opacity: '.45', display: 'block' }}>
                              </span>
                            </span>
                            {' '}
                            <span style={{ color: '#7F77DD', fontSize: '11px', lineHeight: '1' }}>
                              ▲
                            </span>
                            {' '}
                            <span style={{ fontFamily: '\'Sora\',sans-serif', fontWeight: '600', fontSize: '7.5px', letterSpacing: '.08em', textTransform: 'uppercase', color: '#7a5f6c' }}>
                          ...
                          <span style={{ flex: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,.03)', border: '.5px solid rgba(255,255,255,.07)', borderRadius: '12px', padding: '10px 4px 8px' }}>
                            {' '}
                            <span style={{ display: 'flex', alignItems: 'flex-end', gap: '3px', height: '32px' }}>
                              <span style={{ width: '5px', height: '26px', borderRadius: '2px 2px 0 0', background: '#c1216b', display: 'block' }}>
                              </span>
                              <span style={{ width: '5px', height: '21px', borderRadius: '2px 2px 0 0', background: '#c1216b', opacity: '.7', display: 'block' }}>
                              </span>
                              <span style={{ width: '5px', height: '21px', borderRadius: '2px 2px 0 0', background: '#c1216b', opacity: '.5', display: 'block' }}>
                              </span>
                            </span>
                            {' '}
                            <span style={{ color: '#c1216b', fontSize: '11px', lineHeight: '1' }}>
                              ♥
                            </span>
                            {' '}
                            <span style={{ fontFamily: '\'Sora\',sans-serif', fontWeight: '600', fontSize: '7.5px', letterSpacing: '.08em', textTransform: 'uppercase', color: '#7a5f6c' }}>
                          ...
                          <span style={{ flex: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,.03)', border: '.5px solid rgba(255,255,255,.07)', borderRadius: '12px', padding: '10px 4px 8px' }}>
                            {' '}
                            <span style={{ display: 'flex', alignItems: 'flex-end', gap: '3px', height: '32px' }}>
                              <span style={{ width: '5px', height: '21px', borderRadius: '2px 2px 0 0', background: '#c87c4a', display: 'block' }}>
                              </span>
                              <span style={{ width: '5px', height: '26px', borderRadius: '2px 2px 0 0', background: '#6f7a5e', display: 'block' }}>
                              </span>
                            </span>
                            {' '}
                            <span style={{ color: '#c87c4a', fontSize: '11px', lineHeight: '1' }}>
                              ⌂
                            </span>
                            {' '}
                            <span style={{ fontFamily: '\'Sora\',sans-serif', fontWeight: '600', fontSize: '7.5px', letterSpacing: '.08em', textTransform: 'uppercase', color: '#7a5f6c' }}>
                          ...
                          <span style={{ flex: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,.03)', border: '.5px solid rgba(255,255,255,.07)', borderRadius: '12px', padding: '10px 4px 8px' }}>
                            {' '}
                            <span style={{ display: 'flex', alignItems: 'flex-end', gap: '3px', height: '32px' }}>
                              <span style={{ width: '5px', height: '26px', borderRadius: '2px 2px 0 0', background: '#5B8A5E', display: 'block' }}>
                              </span>
                              <span style={{ width: '5px', height: '16px', borderRadius: '2px 2px 0 0', background: '#5B8A5E', opacity: '.55', display: 'block' }}>
                              </span>
                            </span>
                            {' '}
                            <span style={{ color: '#5B8A5E', fontSize: '11px', lineHeight: '1' }}>
                              ✦
                            </span>
                            {' '}
                            <span style={{ fontFamily: '\'Sora\',sans-serif', fontWeight: '600', fontSize: '7.5px', letterSpacing: '.08em', textTransform: 'uppercase', color: '#7a5f6c' }}>
                      ...
                      {' '}
                      <div style={{ marginTop: '12px', display: 'flex', alignItems: 'center', gap: '10px', background: 'rgba(233,192,106,.08)', border: '.5px solid rgba(233,192,106,.4)', borderRadius: '14px', padding: '11px 14px' }}>
                        {' '}
                      ...
                      {' '}
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', marginTop: '14px', opacity: '.6' }}>
                        <span style={{ fontFamily: '\'Sora\',sans-serif', fontWeight: '800', fontSize: '9px', letterSpacing: '.28em', color: '#c4a0b2' }}>
