...
export function Hero() {
  return (
    <>
            {/* ══ HERO ══ */}
            <section data-screen-label="Hero" style={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', overflow: 'hidden', padding: 'clamp(76px,10vh,110px) clamp(18px,4vw,30px) clamp(50px,8vh,80px)', scrollSnapAlign: 'start' }}>
              {' '}
              ...
              {' '}
              <div style={{ position: 'absolute', bottom: '26px', left: '50%', transform: 'translateX(-50%)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', color: '#9e7a8c' }}>
                {' '}
