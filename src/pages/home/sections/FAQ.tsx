...
export function FAQ() {
  ...
  const plus: React.CSSProperties = { color: '#e7548a', fontSize: '20px', fontWeight: 300 }
  const p: React.CSSProperties = { fontFamily: "'Newsreader',serif", fontStyle: 'italic', fontSize: '15px', color: '#6b4a5c', lineHeight: 1.6, margin: '10px 0 0', maxWidth: '52ch' }
  return (
    <section data-screen-label="FAQ" style={{ position: 'relative', background: '#fdf0f5', padding: 'clamp(46px,7vh,80px) 22px clamp(36px,5vh,60px)' }}>
      <div style={{ maxWidth: '740px', margin: '0 auto' }}>
        <div data-rv="">
          <div style={{ fontFamily: "'Sora',sans-serif", fontWeight: 700, fontSize: '11px', letterSpacing: '.18em', textTransform: 'uppercase', color: '#e7548a', marginBottom: '14px' }}>what is shutap</div>
          ...
          <p style={{ fontFamily: "'Newsreader',serif", fontStyle: 'italic', fontSize: '17px', lineHeight: 1.65, color: '#2e1a26', margin: '0 0 10px', maxWidth: '52ch' }}>
          ...
          <p style={{ fontFamily: "'Newsreader',serif", fontStyle: 'italic', fontSize: '15.5px', lineHeight: 1.65, color: '#6b4a5c', margin: '0 0 24px', maxWidth: '52ch' }}>
